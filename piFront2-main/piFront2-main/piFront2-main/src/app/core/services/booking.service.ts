...
export class BookingService {
  ...
  private bookingApi  = 'http://localhost:8222/api/bookings';
  private sessionApi  = 'http://localhost:8222/api/sessions';
  private feedbackApi = 'http://localhost:8222/api/feedback';
        ...
        (users ?? [])
          ...
          .map((u: any) => ({
            ...
            specialization: u.specialization
              ? (Array.isArray(u.specialization) ? u.specialization : [u.specialization])
              : [],
            // Ensure all tutor properties are present
            bio: u.bio || '',
            experienceYears: u.experienceYears || 0,
            hourlyRate: u.hourlyRate || 0,
            rating: u.rating || 0,
            reviewCount: u.reviewCount || 0,
            languages: u.languages ? (Array.isArray(u.languages) ? u.languages : [u.languages]) : ['English'],
