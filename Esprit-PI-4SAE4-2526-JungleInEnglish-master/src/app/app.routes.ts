...
import { StudentCoursesComponent } from './frontoffice/jungle/student/student-courses/student-courses.component';
...
import { AdminCoursesComponent } from './backoffice/pages/courses/admin-courses.component';
import { AdminCourseFormComponent } from './backoffice/pages/courses/admin-course-form.component';
...
export const routes: Routes = [
  ...
  // ── Public Shell ──────────────────────────────
  {
    ...
    children: [
      ...
      // public access to courses pages (no login required)
      { path: 'student-courses', component: StudentCoursesComponent },
      { path: 'courses',         component: AdminCoursesComponent },
      { path: 'courses/new',     component: AdminCourseFormComponent },
      { path: 'courses/:id',     component: AdminCourseFormComponent },
    ]
  },
