...
export const routes: Routes = [
  ...
  loadComponent: () =>
    import('./frontoffice/jungle/student/timeslots-calendar/timeslots-calendar.component')
      .then(m => m.TimeslotsCalendarComponent)
      },
      {
  ...
  path: 'tutor/sessions',
  loadChildren: () =>
    import('./frontoffice/jungle/tutor/sessions/sessions.routes')
      .then(m => m.sessionsRoutes),
  canActivate: [roleGuard('TUTOR')]
     },
{
  path: 'tutor/timeslots',
  loadComponent: () =>
    import('./frontoffice/jungle/tutor/timeslots-calendar/timeslots-calendar.component')
      .then(m => m.TimeslotsCalendarComponent),
  canActivate: [roleGuard('TUTOR')]
},
    ]
  ...
  // ── Admin Shell ────────────────────────────────
  {
    ...
    children: [
      ...
      path: 'timeslots',
      loadComponent: () =>
        import('./backoffice/pages/timeslots-calendar/timeslots-calendar.component')
          .then(m => m.TimeslotsCalendarComponent)
      },
      {
  path: 'sessions',
  loadChildren: () =>
    import('./backoffice/pages/sessions/sessions.routes')
      .then(m => m.sessionsRoutes)
}
    ]
  },
