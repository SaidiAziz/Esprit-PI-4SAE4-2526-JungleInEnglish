...
public class BookingHistoryService {
    ...
    public List<BookingHistory> getByNewStatus(BookingStatusHistory status) {
        return historyRepository.findByNewStatus(status);
    }

    public List<BookingHistory> getByBookingAndStatus(Long bookingId, BookingStatusHistory status) {
